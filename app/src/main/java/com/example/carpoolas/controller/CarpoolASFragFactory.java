...
public class CarpoolASFragFactory extends FragmentFactory {

    private static final String VIEW_PACKAGE = "com.example.carpoolas.view"; // package where all the view reside
    private final com.example.carpoolas.controller.MainActivity controller; // the controller instance to pass to fragments

    /**
     * Constructor method.
     * @param controller the activity to pass in to fragments
     */
    public CarpoolASFragFactory(MainActivity controller){
